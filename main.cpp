...
int main(int argc, char* argv[])
{
    ...
    // for(int i = 1; i < 6; i++)
    {
        for(int j = 0; j < runs; j++)
        {
            ...
            GA ga(argc, argv, i, j, ga_variant_option, mutation_probability, xover_probability);
                ...
                case 1:
                    ...
                    else
                    {
                        ...
                        // {
                            ...
                            //TESET
                            std::cout << "GA VARIANT OPTION = " << ga_variant_option << std::endl;

                            ga.set_option_mutation_prob(0.001);
                            ga.set_option_xover_prob(0.667);
        ...
        GA ga(argc, argv, i, runs, ga_variant_option, mutation_probability, xover_probability);
        switch(ga_variant_option)
        {
            case 1:
                ga.set_option_ga_variant_name("S");
        ...
        std::string dir("_" + ga.get_options().ga_variant_name + "_deJong_F" + std::to_string(ga.get_options().eval_option));
        mkdir(dir.c_str(), S_IRWXU);
        std::string temp_name;
        std::string new_temp_name;
        for(int i = 0; i < runs; i++)
        {
            temp_name = "output_" + ga.get_options().ga_variant_name + "_deJong_F" + std::to_string(ga.get_options().eval_option) + "_" + std::to_string(i) + ".txt";
            new_temp_name = dir + "/output_" + ga.get_options().ga_variant_name + "_deJong_F" + std::to_string(ga.get_options().eval_option) + "_" + std::to_string(i) + ".txt";
            rename(temp_name.c_str(), new_temp_name.c_str());
            temp_name.clear();
            new_temp_name.clear();
            temp_name = "output_" + ga.get_options().ga_variant_name + "_deJong_F" + std::to_string(ga.get_options().eval_option) + "_O_" + std::to_string(i) + ".txt";
            new_temp_name = dir + "/output_" + ga.get_options().ga_variant_name + "_deJong_F" + std::to_string(ga.get_options().eval_option) + "_O_" + std::to_string(i) + ".txt";
            rename(temp_name.c_str(), new_temp_name.c_str());
        }
        temp_name.clear();
        new_temp_name.clear();
        temp_name = "output_" + ga.get_options().ga_variant_name + "_deJong_F" + std::to_string(ga.get_options().eval_option) + "_AVE.txt";
        new_temp_name = dir + "/output_" + ga.get_options().ga_variant_name + "_deJong_F" + std::to_string(ga.get_options().eval_option) + "_AVE.txt";
        rename(temp_name.c_str(), new_temp_name.c_str());
        temp_name.clear();
        new_temp_name.clear();
        temp_name = "output_" + ga.get_options().ga_variant_name + "_deJong_F" + std::to_string(ga.get_options().eval_option) + "_O_AVE.txt";
        new_temp_name = dir + "/output_" + ga.get_options().ga_variant_name + "_deJong_F" + std::to_string(ga.get_options().eval_option) + "_O_AVE.txt";
        rename(temp_name.c_str(), new_temp_name.c_str());
    }
